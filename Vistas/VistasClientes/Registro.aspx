<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Cliente.Master" AutoEventWireup="true"
    CodeBehind="Registro.aspx.cs" Inherits="Vistas.Registro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-4" style="margin-left: 20px;">
        ...
        <div class="form-group" style="border-right: 1px solid;">
                    <asp:HyperLink ID="lnkProductor" runat="server" NavigateUrl="~/VistasClientes/RegistroP.aspx" Text="Registrarme como Productor" />
                </div>
        <div class="form-group">            
            <strong>
